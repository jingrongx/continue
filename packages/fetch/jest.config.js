...
const config = {
    ...
    //   "/node_modules/"
    // ],
    // 指定应使用哪个提供程序来为覆盖率提供代码
    coverageProvider: "v8",
    // Jest 在编写覆盖报告时使用的报告器名称列表
    // coverageReporters: [
    //   "json",
    //   "text",
    //   "lcov",
    ...
    // 需要在所有测试环境中可用的一组全局变量
    // globals: {},
    // 用于运行测试的最大工作者数量。可以指定为百分比或数字。例如，maxWorkers: 10% 将使用 CPU 数量的 10% + 1 作为最大工作者数量。maxWorkers: 2 将最多使用 2 个工作者。
    // maxWorkers: "50%",
